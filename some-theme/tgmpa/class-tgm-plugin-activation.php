...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function overload_textdomain_mofile( $mofile, $domain ) {
			...
			// phpcs:ignore WordPress.PHP.NoSilencedErrors.Discouraged,Generic.PHP.NoSilencedErrors.Forbidden -- Derp.
		...
		public function admin_init() {
			...
			if ( isset( $_REQUEST['tab'] ) && 'plugin-information' === $_REQUEST['tab'] ) {
				...
				global $tab, $body_id;
				// phpcs:ignore WPThemeReview.CoreFunctionality.PrefixAllGlobals.NonPrefixedVariableFound -- WP requirement.
				...
				class TGMPA_Bulk_Installer extends Plugin_Upgrader {
					...
					public function bulk_install( $plugins, $args = array() ) {
						...
						*/
						 ...
						 */
						do_action(
							// phpcs:ignore WPThemeReview.CoreFunctionality.PrefixAllGlobals.NonPrefixedHooknameFound -- Using WP core hook.
